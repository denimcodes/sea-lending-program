...
def init_lending_market(owner: Signer, lending_market: Empty[LendingMarket]):
  ...
  lending_market = lending_market.init(
    payer = owner,
    seeds = ["lending-market", owner]
  )
...
def borrow(
  ...
  assert borrow_amount < obligation.deposited_amount, "Borrowed amount cannot be more than deposited amount"
...
def withdraw(
  ...
  assert withdraw_amount <= obligation.deposited_amount, "Withdraw amount cannot be more than deposited amount"
...
def repay(
  ...
  assert repay_amount <= obligation.borrowed_amount, "Repaid amount cannot be greater than borrowed amount"
